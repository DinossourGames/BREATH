...
namespace DinoOtter
{
    ...
    public class Color
    {
        ...
        /// <summary>
        /// Returns a color from system draw.
        /// Made it to use Rider Functions.
        /// </summary>
        /// <param name="color"></param>
        /// <returns></returns>
        public static Color FromDraw(System.Drawing.Color color) => FromBytes(color.R, color.G, color.B, color.A);
        ...
        {
            return "Color [R: " + R.ToString("0.00") + " G: " + G.ToString("0.00") + " B: " + B.ToString("0.00") +
                   " A: " + A.ToString("0.00") + "]";
        }
        ...
        {
            get { return ByteR.ToString("X2") + ByteG.ToString("X2") + ByteB.ToString("X2") + ByteA.ToString("X2"); }
        }

...
namespace DinoOtter
{
    /// <summary>
    ///  ᶜ(ᵔᴥᵔ)ᵓ
    ///  Core class DinoOtter. Create a Game, and then use Game.Start(); to run it.
    /// </summary>
    public class Game
    {
            ...
            bool fullscreen = false)
        {
            ...
            Console.WriteLine("[ DinoOtter is running in debug mode! ]");
